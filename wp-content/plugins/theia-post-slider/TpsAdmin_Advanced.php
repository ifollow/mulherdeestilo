		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<label>
							<input type="radio" id="tps_ad_refreshing_mechanism_javascript" name="tps_advanced[ad_refreshing_mechanism]" value="javascript" <?php echo $options['ad_refreshing_mechanism'] == 'javascript' ? 'checked' : ''; ?>>
						...
						<br>
						<label>
							<input type="radio" id="tps_ad_refreshing_mechanism_page" name="tps_advanced[ad_refreshing_mechanism]" value="page" <?php echo $options['ad_refreshing_mechanism'] == 'page' ? 'checked' : ''; ?>>
							Refresh ads by refreshing the entire page.
							<p class="description">Works with any other ads, including Google AdSense. Transition effects will not be used when refreshing the page.</p>
						</label>
						<p></p>
					</td>
				</tr>
