...
<?php comment_form(
	...
	array(
		...
		'title_reply' => '<h4 class="post-header"><span class="post-header">' . __( 'Comentários', 'mvp-text' ) . '</span></h4>',

		'title_reply_to' => '<h4 class="post-header"><span class="post-header">' . __( 'Postar resposta', 'mvp-text' ) . '</span></h4>',
